...
<script type="text/javascript">
	...
	function toPrint(id){
		window.open("${path}/train/toIncomePrint.do?id="+id);
	}
...
<div class="form_rowelem"> 
 	<form id="form1" action="${path }/train/addIncome.do" method="post">
 		<div class="form_rowelem"> 
	    ...
	    <div class="form_rowelem"> 
	        ...
	        <input type="text" name="formMap[income]" id="income" size="20" maxlength="10" class="maxlength_10 form_input_text" style="width: 200px;" />
	    </div> 
	    <div class="form_rowelem"> 
		    ...
		    <table id="table_list" class="tablecss"  border="1" style="overflow-x: auto;" >
			    ...
			    <c:forEach items="${incomeMapList}" var="income" varStatus="varStatus">
			    	<tr>
				        ...
				        <td>
			        			<a href="#" onclick="toPrint(${income.id})">打印收据</a>
				        </td>
			        </tr>
			    </c:forEach>
		 	</table>
