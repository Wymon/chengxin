...
<div class="form_rowelem"> 
 	<form id="form1" action="${path }/trainReport/exportReport.do" method="post">
 		      
	    <div class="form_rowelem"> 
	        <label class="form_label"><font color="red">*</font>开始日期：</label>
	    ...
	    <div class="form_rowelem"> 
	        <label class="form_label"><font color="red">*</font>结束日期：</label>
