...
<div class="form_rowelem"> 
 	<form id="form1" action="${path }/trainBack/updateAudtiAutumnNumber.do" method="post">
 		<input type="hidden" name="id" value = "${backMap.id }"/>
 		 <div class="form_rowelem"> 
	 			<span class="form_rowelem_span" style="margin-left: 80px;">修改前立秋编号：</span>
	 			<span class="form_rowelem_span" >${oldMap.autumnNumber }</span>
		  </div> 
 		 
 		 <div class="form_rowelem"> 
	 			<span class="form_rowelem_span" style="margin-left: 80px;">修改后立秋编号：</span>
	 			<span class="form_rowelem_span" >${backMap.autumnNumber }</span>
		  </div> 
