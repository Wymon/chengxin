	...
	function toSave(){
		if(checked()){
			art.dialog.through({
				title:"提示",
				icon:"warning",
				content:"修改信息一旦确定将不可修改，请确认修改信息无误！谢谢！",
				background: 'white',
				opacity: 0.6,
				lock:true,
				ok:true,
...
<div class="form_rowelem"> 
 	<form id="form2" action="${path }/trainBack/updateTrain.do" method="post">
 		<div class="form_rowelem"> 
	    ...
	    <div class="form_rowelem" id="createTime_c" <c:if test="${trainMap.newOrOld=='新'||trainMap.newOrOld=='' }">style="display:none"</c:if>> 
	    ...
	    <div class="form_rowelem"> 
	        ...
	        <textarea name="formMap[updateNote]" id="updateNote" cols="45" rows="8">${trainMap.updateNote }</textarea>
	    </div> 
