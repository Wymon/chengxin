...
@Service
public class IncomeCommonBackServiceImpl implements IncomeCommonBackService {
	@Autowired
	private DaoUtil dao;
	@Override
	...
	public List<Map<String, Object>> queryByParam(Map<String, Object> queryMap) {
		...
		sql.append("select i.* from tb_incomecommon_back i where 1=1 ");
	...
	public List<Map<String, Object>> queryBack() {
		String sql = "select i.*,b.id backId ,b.updateStatus,b.createUser bcreateUser from tb_incomeCommon i left join tb_incomeCommon_back b on i.id = b.incomeId and b.updateStatus =0  where  i.status = 0 ";
		return this.dao.queryForList(sql.toString());
	}

	@Override
	public Map<String, Object> findBackByIncomeId(Long IncomeId) {
		String sql = "select * from tb_incomeCommon_back where incomeId = ? and updateStatus = 0 ";
	...
	public PageList queryPageList(Map<String, Object> queryMap, Integer index,
		...
		sql.append("select i.*,b.id backId ,b.updateStatus,b.createUser bcreateUser from tb_incomeCommon i left join tb_incomeCommon_back b on i.id = b.incomeId and b.updateStatus =0  where  1 = 1 ");
